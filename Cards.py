...
def match_card(qCard, train_ranks, train_suits):
    ...
    best_rank_match_diff = 5000
    best_suit_match_diff = 5000
...
def draw_results(image, qCard):
    ...
    if rank_name and suit_name != 'Unknown':
        print(rank_name + suit_name)

##    ser = serial.Serial ('/dev/ttvS0', 9600)    #Open port with baud rate
##    while True:
...
##
##    file = open(r'C:\Users\Gustavs PC\OneDrive\Skrivebord\ranksuit.txt', 'w')
##    if received_data == 'ReadCard':
    if rank_name and suit_name != 'Unknown':
        file = open(r'C:\Users\Gustavs PC\OneDrive\Skrivebord\ranksuit.txt', 'w')
        file.write(rank_name+suit_name)
        file.close()
